        ...
        <>
          ...
          <div className="payParent">
            <form className="pDiv2" onSubmit={handleSubmit}>
              ...
              >
                <span className="priceing3 " style={{ marginRight: "20px" }}>
                  Pay Amount :{" "}
                </span>
                {sDate.toLocaleDateString().toString() ===
                eDate.toLocaleDateString().toString()
                  ? bikeInfo.rent + 350 + " Rs."
                  : bikeInfo.rent * Difference_In_Days + 350 + " Rs."}
              </p>
